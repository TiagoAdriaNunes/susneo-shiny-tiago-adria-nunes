...
[![Codecov test coverage](https://codecov.io/gh/TiagoAdriaNunes/susneo-shiny-tiago-adria-nunes/graph/badge.svg)](https://app.codecov.io/gh/TiagoAdriaNunes/susneo-shiny-tiago-adria-nunes)
...
SUSNEO is an interactive energy dashboard built with R Shiny that provides comprehensive analysis and visualization of energy consumption data. The application features:
